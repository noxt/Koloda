...
private let defaultRotationAngle: CGFloat = CGFloat(Double.pi) / 20.0
private let defaultScaleMin: CGFloat = 0.9
...
public class DraggableCardView: UIView, UIGestureRecognizerDelegate {
    ...
    public override func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
        ...
        return fabs(velocity.x) > fabs(velocity.y) && super.gestureRecognizerShouldBegin(gestureRecognizer)
    }
}
